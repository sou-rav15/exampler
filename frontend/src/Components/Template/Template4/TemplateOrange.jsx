...
function TemplateOrange() {

  return (
    <>
     <div className='bg-gray-500 w-full font-lora h-[1100px] flex justify-center items-center
     '>
     <div className='w-[816px] h-[1056px] bg-white flex justify-center items-center'>
        <div className='relative bg-gray- w-[95%] h-[98%]'>
            ...
            <div className='w-full h-[112px]  flex flex-col justify-center items-center'>
               <div>
               <h className="text-4xl">{""||"Amit kumar"}</h>
               </div>
            ...
            <div>
                {/* education */}
                <h2 className='text-l font-bold text-[#d45e01]'>Education</h2>
                <div className='border-b-2 border-[#d45e01]'></div>
            ...
            {/* work Experience */}
            <div className=''>
               <h2 className='text-l font-bold text-[#d45e01] mt-0'>work Experience</h2>
                <div className='border-b-2 border-[#d45e01]'></div>
            ...
            {/* project */}
            <div>
            <h2 className='text-l font-bold text-[#d45e01] mt-2'>{""||"Project"}</h2>
            <div className='border-b-2 border-[#d45e01]'></div>
            <div>
                <ul>
            ...
            {/* Techincal skills */}
            <div>
                <h2 className='text-l font-bold text-[#d45e01] mt-2'>Technical Skills</h2>
               <div className='border-b-2 border-[#d45e01]'></div>
                <div>
                <ul>
                    <li>{""||"line 1 "}</li>
            ...
            {/* Honors and awards */}
            <div>
            <h2 className='text-l font-bold text-[#d45e01] mt-2'>Honor and Awards</h2>
            <div className='border-b-2 border-[#d45e01]'></div>
            <div>
            ...
            {/* Achivememts */}
            <div>
            <h2 className='text-l font-bold text-[#d45e01] mt-2'>Achivements</h2>
            <div className='border-b-2 border-[#d45e01]'></div>
