    ...
    <>
     ...
     <div className='w-[816px] h-[1056px] bg-white flex justify-center items-center'>
        <div className='relative bg-gray- w-[95%] h-[98%]'>
            ...
            <div>
                {/* education */}
                <h2 className='text-l font-bold text-green-700'>Education</h2>
            ...
            {/* work Experience */}
            <div className=''>
               <h2 className='text-l font-bold text-green-700 mt-0'>work Experience</h2>
                <div className='border-b-2 border-green-700'></div>
            ...
            {/* project */}
            <div>
                {data.projects.map((index, project)=>(
                   <>
                    <h2 key={index} className='text-l font-bold text-green-700 mt-2'>{""||project.heading}</h2>
                    <div className='border-b-2 border-green-700'></div>
                    <div>
                        <ul>
            ...
            {/* Techincal skills */}
            <div>
                <h2 className='text-l font-bold text-green-700 mt-2'>Technical Skills</h2>
               <div className='border-b-2 border-green-700'></div>
                <div>
                <ul>
                    <li>{""||"line 1 "}</li>
            ...
            {/* Honors and awards */}
            <div>
            <h2 className='text-l font-bold text-green-700 mt-2'>Honor and Awards</h2>
            <div className='border-b-2 border-green-700'></div>
            <div>
            ...
            {/* Achivememts */}
            <div>
            <h2 className='text-l font-bold text-green-700 mt-2'>Achivements</h2>
            <div className='border-b-2 border-green-700'></div>
